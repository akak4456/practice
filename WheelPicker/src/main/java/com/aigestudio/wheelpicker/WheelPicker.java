    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            if (isCurved) {
                ...
                // Log.e("TMPTEST", transX + ":" + transY);
                mCamera.save();
                /*
                Camera.rotateX(degree) 는 휴대폰의 가로 축을 기준으로 회전을 의미하고
                Camera.rotateY(degree) 는 휴대폰의 세로 축을 기준으로 회전을 의미하고
                Camera.rotateZ(degree) 는 휴대폰을 평면으로 봤을 때 그 법선 벡터를 기준으로 회전하는 것을 의미한다.
                즉 x축은 휴대폰의 가로 축
                y축은 휴대폰의 세로 축
                z축은 휴대폰을 평면으로 보았을 때 법선벡터 임을 의미한다.
                 */
