package com.makeus.kkongi.image_cropper_like_ios.cropper.cropoverlay;
...
import com.makeus.kkongi.image_cropper_like_ios.cropper.cropoverlay.utils.PaintUtil;
...
public class CropOverlayView extends View implements IGetImageBounds {
    ...
    public CropOverlayView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mRatio = ta.getInteger(R.styleable.CropOverlayView_ratio,1);
        } finally {
            ta.recycle();
        }
...
//        paint.setAlpha(0);
    ...
    private void init(Context context) {
        //toolbar의 height는 56dp로 가정함
        int w = context.getResources().getDisplayMetrics().widthPixels;
        int h = context.getResources().getDisplayMetrics().heightPixels;
        cropWidth = w - 2 * mMarginSide;
        //noinspection SuspiciousNameCombination
        cropHeight = cropWidth * mRatio;
        mMarginTop = (h - cropHeight - ((int) convertDpToPixel(56.0f))) / 2;
